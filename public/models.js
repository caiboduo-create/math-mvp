(function () {
  ...
  const customInteractiveTemplates = {
    ...
    "polynomial-multiply": "area-multiplication",
    "multiplication-formula": "square-formula-area",
    factorization: "reverse-area-factorization",
  ...
  const interactiveDescriptions = {
    ...
    "area-multiplication": "用面积模型理解多项式乘法的分配过程。",
    "square-formula-area": "用正方形面积理解乘法公式。",
    "reverse-area-factorization": "从面积拼图反推因式分解结构。",
